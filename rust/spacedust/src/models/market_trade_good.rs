...
impl MarketTradeGood {
    pub fn new(symbol: crate::models::TradeSymbol, r#type: Type, trade_volume: i32, supply: crate::models::SupplyLevel, purchase_price: i32, sell_price: i32) -> MarketTradeGood {
        MarketTradeGood {
            symbol,
            r#type,
            trade_volume,
